...
public class Instructor implements Serializable{
	...
	Instructor(String firstName, String lastName, String department){
	...
	public boolean equals(Object o) {
		...
		Instructor instructor = (Instructor)o;
			...
			return instructor.firstName.equals(firstName) &&
					instructor.lastName.equals(lastName) &&
                     instructor.department.equals(department) &&
                      instructor.email.equals(email);
	}
	public int hashCode() {
		int res = 8;
